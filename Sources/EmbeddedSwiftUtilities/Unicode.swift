...
/// Binary-search over Unicode decimal digit ranges (Nd, 71 ranges).
public func unicodeScalarIsDigit(_ value: UInt32) -> Bool {
  unicodeBinarySearch(unicodeDigitRanges, value)
}

/// Binary-search over Unicode math+other symbol and letter+other number ranges.
/// Excludes emoji (U+1F000+) which render badly at small sizes.
public func unicodeScalarIsVisualSymbolOrNumber(_ value: UInt32) -> Bool {
  value < 0x1F000 && (
    unicodeBinarySearch(unicodeMathSymbolRanges, value)
    || unicodeBinarySearch(unicodeOtherSymbolRanges, value)
    || unicodeBinarySearch(unicodeLetterNumberRanges, value)
    || unicodeBinarySearch(unicodeOtherNumberRanges, value)
  )
}

/// True if the scalar is a letter, digit, or visual symbol/number (excludes emoji, combining marks, punctuation, control chars).
public func unicodeScalarIsGridChar(_ value: UInt32) -> Bool {
  unicodeScalarIsLetter(value)
    || unicodeScalarIsDigit(value)
    || unicodeScalarIsVisualSymbolOrNumber(value)
}

@inline(__always)
private func unicodeBinarySearch(_ ranges: [(UInt32, UInt32)], _ value: UInt32) -> Bool {
  var lo = 0
  var hi = ranges.count - 1
  while lo <= hi {
    let mid = (lo + hi) >> 1
    let range = ranges[mid]
    if value < range.0 { hi = mid - 1 }
    else if value > range.1 { lo = mid + 1 }
    else { return true }
  }
  return false
}
...
private let unicodeLetterRanges: [(UInt32, UInt32)] = [
  ...
  (0x531,0x556),(0x559,0x559),(0x560,0x588),(0x5D0,0x5EA),(0x5EF,0x5F2),
  (0x620,0x64A),(0x66E,0x66F),(0x671,0x6D3),(0x6D5,0x6D5),(0x6E5,0x6E6),
  (0x6EE,0x6EF),(0x6FA,0x6FC),(0x6FF,0x6FF),(0x710,0x710),(0x712,0x72F),
  (0x74D,0x7A5),(0x7B1,0x7B1),(0x7CA,0x7EA),(0x7F4,0x7F5),(0x7FA,0x7FA),
  (0x800,0x815),(0x81A,0x81A),(0x824,0x824),(0x828,0x828),(0x840,0x858),
  (0x860,0x86A),(0x870,0x887),(0x889,0x88F),(0x8A0,0x8C9),(0x904,0x939),
  (0x93D,0x93D),(0x950,0x950),(0x958,0x961),(0x971,0x980),(0x985,0x98C),
  (0x98F,0x990),(0x993,0x9A8),(0x9AA,0x9B0),(0x9B2,0x9B2),(0x9B6,0x9B9),
  (0x9BD,0x9BD),(0x9CE,0x9CE),(0x9DC,0x9DD),(0x9DF,0x9E1),(0x9F0,0x9F1),
  (0x9FC,0x9FC),(0xA05,0xA0A),(0xA0F,0xA10),(0xA13,0xA28),(0xA2A,0xA30),
  ...
  (0xAF9,0xAF9),(0xB05,0xB0C),(0xB0F,0xB10),(0xB13,0xB28),(0xB2A,0xB30),
  (0xB32,0xB33),(0xB35,0xB39),(0xB3D,0xB3D),(0xB5C,0xB5D),(0xB5F,0xB61),
  (0xB71,0xB71),(0xB83,0xB83),(0xB85,0xB8A),(0xB8E,0xB90),(0xB92,0xB95),
  (0xB99,0xB9A),(0xB9C,0xB9C),(0xB9E,0xB9F),(0xBA3,0xBA4),(0xBA8,0xBAA),
  (0xBAE,0xBB9),(0xBD0,0xBD0),(0xC05,0xC0C),(0xC0E,0xC10),(0xC12,0xC28),
  (0xC2A,0xC39),(0xC3D,0xC3D),(0xC58,0xC5A),(0xC5C,0xC5D),(0xC60,0xC61),
  (0xC80,0xC80),(0xC85,0xC8C),(0xC8E,0xC90),(0xC92,0xCA8),(0xCAA,0xCB3),
  (0xCB5,0xCB9),(0xCBD,0xCBD),(0xCDC,0xCDE),(0xCE0,0xCE1),(0xCF1,0xCF2),
  (0xD04,0xD0C),(0xD0E,0xD10),(0xD12,0xD3A),(0xD3D,0xD3D),(0xD4E,0xD4E),
  (0xD54,0xD56),(0xD5F,0xD61),(0xD7A,0xD7F),(0xD85,0xD96),(0xD9A,0xDB1),
  (0xDB3,0xDBB),(0xDBD,0xDBD),(0xDC0,0xDC6),(0xE01,0xE30),(0xE32,0xE33),
  (0xE40,0xE46),(0xE81,0xE82),(0xE84,0xE84),(0xE86,0xE8A),(0xE8C,0xEA3),
  (0xEA5,0xEA5),(0xEA7,0xEB0),(0xEB2,0xEB3),(0xEBD,0xEBD),(0xEC0,0xEC4),
  (0xEC6,0xEC6),(0xEDC,0xEDF),(0xF00,0xF00),(0xF40,0xF47),(0xF49,0xF6C),
  (0xF88,0xF8C),(0x1000,0x102A),(0x103F,0x103F),(0x1050,0x1055),(0x105A,0x105D),
  ...
  (0xA722,0xA788),(0xA78B,0xA7DC),(0xA7F1,0xA801),(0xA803,0xA805),(0xA807,0xA80A),
  ...
  (0x10080,0x100FA),(0x10280,0x1029C),(0x102A0,0x102D0),(0x10300,0x1031F),(0x1032D,0x10340),
  (0x10342,0x10349),(0x10350,0x10375),(0x10380,0x1039D),(0x103A0,0x103C3),(0x103C8,0x103CF),
  ...
  (0x10900,0x10915),(0x10920,0x10939),(0x10940,0x10959),(0x10980,0x109B7),(0x109BE,0x109BF),
  ...
  (0x10D00,0x10D23),(0x10D4A,0x10D65),(0x10D6F,0x10D85),(0x10E80,0x10EA9),(0x10EB0,0x10EB1),
  (0x10EC2,0x10EC7),(0x10F00,0x10F1C),(0x10F27,0x10F27),(0x10F30,0x10F45),(0x10F70,0x10F81),
  ...
  (0x113D3,0x113D3),(0x11400,0x11434),(0x11447,0x1144A),(0x1145F,0x11461),(0x11480,0x114AF),
  ...
  (0x11BC0,0x11BE0),(0x11C00,0x11C08),(0x11C0A,0x11C2E),(0x11C40,0x11C40),(0x11C72,0x11C8F),
  (0x11D00,0x11D06),(0x11D08,0x11D09),(0x11D0B,0x11D30),(0x11D46,0x11D46),(0x11D60,0x11D65),
  (0x11D67,0x11D68),(0x11D6A,0x11D89),(0x11D98,0x11D98),(0x11DB0,0x11DDB),(0x11EE0,0x11EF2),
  (0x11F02,0x11F02),(0x11F04,0x11F10),(0x11F12,0x11F33),(0x11FB0,0x11FB0),(0x12000,0x12399),
  (0x12480,0x12543),(0x12F90,0x12FF0),(0x13000,0x1342F),(0x13441,0x13446),(0x13460,0x143FA),
  (0x14400,0x14646),(0x16100,0x1611D),(0x16800,0x16A38),(0x16A40,0x16A5E),(0x16A70,0x16ABE),
  (0x16AD0,0x16AED),(0x16B00,0x16B2F),(0x16B40,0x16B43),(0x16B63,0x16B77),(0x16B7D,0x16B8F),
  (0x16D40,0x16D6C),(0x16E40,0x16E7F),(0x16EA0,0x16EB8),(0x16EBB,0x16ED3),(0x16F00,0x16F4A),
  (0x16F50,0x16F50),(0x16F93,0x16F9F),(0x16FE0,0x16FE1),(0x16FE3,0x16FE3),(0x16FF2,0x16FF3),
  ...
  (0x1BC90,0x1BC99),(0x1D400,0x1D454),(0x1D456,0x1D49C),(0x1D49E,0x1D49F),(0x1D4A2,0x1D4A2),
  ...
  (0x1D7C4,0x1D7CB),(0x1DF00,0x1DF1E),(0x1DF25,0x1DF2A),(0x1E030,0x1E06D),(0x1E100,0x1E12C),
  (0x1E137,0x1E13D),(0x1E14E,0x1E14E),(0x1E290,0x1E2AD),(0x1E2C0,0x1E2EB),(0x1E4D0,0x1E4EB),
  (0x1E5D0,0x1E5ED),(0x1E5F0,0x1E5F0),(0x1E6C0,0x1E6DE),(0x1E6E0,0x1E6E2),(0x1E6E4,0x1E6E5),
  (0x1E6E7,0x1E6ED),(0x1E6F0,0x1E6F4),(0x1E6FE,0x1E6FF),(0x1E7E0,0x1E7E6),(0x1E7E8,0x1E7EB),
  ...
  (0x1EEA1,0x1EEA3),(0x1EEA5,0x1EEA9),(0x1EEAB,0x1EEBB),(0x20000,0x2A6DF),(0x2A700,0x2B81D),
  (0x2B820,0x2CEAD),(0x2CEB0,0x2EBE0),(0x2EBF0,0x2EE5D),(0x2F800,0x2FA1D),
]

private let unicodeDigitRanges: [(UInt32, UInt32)] = [
  (0x660,0x669),(0x6F0,0x6F9),(0x7C0,0x7C9),(0x966,0x96F),(0x9E6,0x9EF),
  (0xA66,0xA6F),(0xAE6,0xAEF),(0xB66,0xB6F),(0xBE6,0xBEF),(0xC66,0xC6F),
  (0xCE6,0xCEF),(0xD66,0xD6F),(0xDE6,0xDEF),(0xE50,0xE59),(0xED0,0xED9),
  (0xF20,0xF29),(0x1040,0x1049),(0x1090,0x1099),(0x17E0,0x17E9),(0x1810,0x1819),
  (0x1946,0x194F),(0x19D0,0x19D9),(0x1A80,0x1A89),(0x1A90,0x1A99),(0x1B50,0x1B59),
  (0x1BB0,0x1BB9),(0x1C40,0x1C49),(0x1C50,0x1C59),(0xA620,0xA629),(0xA8D0,0xA8D9),
  (0xA900,0xA909),(0xA9D0,0xA9D9),(0xA9F0,0xA9F9),(0xAA50,0xAA59),(0xABF0,0xABF9),
  (0xFF10,0xFF19),(0x104A0,0x104A9),(0x10D30,0x10D39),(0x10D40,0x10D49),(0x11066,0x1106F),
  ...
  (0x11DA0,0x11DA9),(0x11DE0,0x11DE9),(0x11F50,0x11F59),(0x16130,0x16139),(0x16A60,0x16A69),
...
private let unicodeMathSymbolRanges: [(UInt32, UInt32)] = [
  ...
  (0xFF5E,0xFF5E),(0xFFE2,0xFFE2),(0xFFE9,0xFFEC),(0x10D8E,0x10D8F),(0x1CEF0,0x1CEF0),
...
private let unicodeOtherSymbolRanges: [(UInt32, UInt32)] = [
  ...
  (0x23B4,0x23DB),(0x23E2,0x2429),(0x2440,0x244A),(0x249C,0x24E9),(0x2500,0x25B6),
  (0x25B8,0x25C0),(0x25C2,0x25F7),(0x2600,0x266E),(0x2670,0x2767),(0x2794,0x27BF),
  (0x2800,0x28FF),(0x2B00,0x2B2F),(0x2B45,0x2B46),(0x2B4D,0x2B73),(0x2B76,0x2BFF),
  (0x2CE5,0x2CEA),(0x2E50,0x2E51),(0x2E80,0x2E99),(0x2E9B,0x2EF3),(0x2F00,0x2FD5),
  (0x2FF0,0x2FFF),(0x3004,0x3004),(0x3012,0x3013),(0x3020,0x3020),(0x3036,0x3037),
  (0x303E,0x303F),(0x3190,0x3191),(0x3196,0x319F),(0x31C0,0x31E5),(0x31EF,0x31EF),
  ...
  (0xA839,0xA839),(0xAA77,0xAA79),(0xFBC3,0xFBD2),(0xFD40,0xFD4F),(0xFD90,0xFD91),
  (0xFDC8,0xFDCF),(0xFDFD,0xFDFF),(0xFFE4,0xFFE4),(0xFFE8,0xFFE8),(0xFFED,0xFFEE),
  (0xFFFC,0xFFFD),(0x10137,0x1013F),(0x10179,0x10189),(0x1018C,0x1018E),(0x10190,0x1019C),
  (0x101A0,0x101A0),(0x101D0,0x101FC),(0x10877,0x10878),(0x10AC8,0x10AC8),(0x10ED1,0x10ED8),
  (0x1173F,0x1173F),(0x11FD5,0x11FDC),(0x11FE1,0x11FF1),(0x16B3C,0x16B3F),(0x16B45,0x16B45),
  (0x1BC9C,0x1BC9C),(0x1CC00,0x1CCEF),(0x1CCFA,0x1CCFC),(0x1CD00,0x1CEB3),(0x1CEBA,0x1CED0),
  (0x1CEE0,0x1CEEF),(0x1CF50,0x1CFC3),(0x1D000,0x1D0F5),(0x1D100,0x1D126),(0x1D129,0x1D164),
  (0x1D16A,0x1D16C),(0x1D183,0x1D184),(0x1D18C,0x1D1A9),(0x1D1AE,0x1D1EA),(0x1D200,0x1D241),
  (0x1D245,0x1D245),(0x1D300,0x1D356),(0x1D800,0x1D9FF),(0x1DA37,0x1DA3A),(0x1DA6D,0x1DA74),
...
private let unicodeOtherNumberRanges: [(UInt32, UInt32)] = [
  ...
  (0x19DA,0x19DA),(0x2070,0x2070),(0x2074,0x2079),(0x2080,0x2089),(0x2150,0x215F),
  (0x2189,0x2189),(0x2460,0x249B),(0x24EA,0x24FF),(0x2776,0x2793),(0x2CFD,0x2CFD),
  (0x3192,0x3195),(0x3220,0x3229),(0x3248,0x324F),(0x3251,0x325F),(0x3280,0x3289),
  (0x32B1,0x32BF),(0xA830,0xA835),(0x10107,0x10133),(0x10175,0x10178),(0x1018A,0x1018B),
  (0x102E1,0x102FB),(0x10320,0x10323),(0x10858,0x1085F),(0x10879,0x1087F),(0x108A7,0x108AF),
  ...
  (0x10B78,0x10B7F),(0x10BA9,0x10BAF),(0x10CFA,0x10CFF),(0x10E60,0x10E7E),(0x10F1D,0x10F26),
  (0x10F51,0x10F54),(0x10FC5,0x10FCB),(0x11052,0x11065),(0x111E1,0x111F4),(0x1173A,0x1173B),
  (0x118EA,0x118F2),(0x11C5A,0x11C6C),(0x11FC0,0x11FD4),(0x16B5B,0x16B61),(0x16E80,0x16E96),
  (0x1D2C0,0x1D2D3),(0x1D2E0,0x1D2F3),(0x1D360,0x1D378),(0x1E8C7,0x1E8CF),(0x1EC71,0x1ECAB),
  (0x1ECAD,0x1ECAF),(0x1ECB1,0x1ECB4),(0x1ED01,0x1ED2D),(0x1ED2F,0x1ED3D),(0x1F100,0x1F10C),
]
